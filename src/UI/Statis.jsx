...
function Statis() {
  return (
    <>
      <span className=" shad flex md:m-0 m-auto text-center 4xl:w-[680px] 3xl:w-[450px] 2xl:w-[500px] xl:w-[480px] lg:w-[500px] w-[450px] md:h-[90px] sm:h-[80px] h-[60px] md:ml-2 bg-vanilla-600 rounded-xl ">
      ...
      <span className=" shad flex md:m-0 m-auto text-center 4xl:w-[680px] 3xl:w-[450px] 2xl:w-[500px] xl:w-[480px] lg:w-[500px] w-[450px] md:h-[90px] sm:h-[80px] h-[60px] bg-vanilla-600 rounded-xl ">
        <span className=" bg-sky-900 rounded-full ml-5 md:text-6xl text-3xl p-2 my-auto text-vanilla-200 ">
          <FaPeopleGroup />
        </span>
        <span className="md:text-2xl sm:text-lg text-sm  text-vanilla-200 my-auto ml-3 ">
          Total Employees 48
